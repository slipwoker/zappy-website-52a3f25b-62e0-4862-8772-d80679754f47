document.addEventListener('DOMContentLoaded', function () {
  ...
  const ANIMATE_SELECTOR = '.animate-on-scroll, .fade-in, .slide-up, .reveal';

  function addAnimationTargets() {
    ...
    "translations": {
      "en": {
        "consentModal": {
          ...
          "description": "בית הנייד והמחשב uses cookies to enhance your experience, analyze site usage, and assist in our marketing efforts. You can manage your preferences anytime.",
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '52a3f25b-62e0-4862-8772-d80679754f47',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '52a3f25b-62e0-4862-8772-d80679754f47';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '52a3f25b-62e0-4862-8772-d80679754f47';
